...
/* Loader show/hide with minimum display time (≈2.5s) */
...
/* ParticlesJS: theme-aware + more visible + interactive */
...
function loadParticles(mode) {
  ...
  particlesJS("particles-js", {
    particles: {
      ...
      color: { value: colors },
      shape: { type: "circle" },
      opacity: { value: isLight ? 0.32 : 0.26 },
    ...
    interactivity: {
      ...
      modes: {
        ...
        push: { particles_nb: 3 },
        bubble: { distance: 160, size: 6, duration: 2, opacity: 0.4 }
      }
    },
    retina_detect: true
  });
